          ...
          {user ? (
            ...
            <div ref={userMenuRef} className="relative">
              <button
                ...
                className="flex items-center gap-2 pl-2 pr-3 py-1.5 rounded-xl border border-gray-200 hover:border-green-400 hover:bg-gray-50 transition-colors text-sm font-medium text-gray-700"
                aria-haspopup="true"
        ...
        <div className="md:hidden border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-4 py-4 space-y-1 shadow-md">
          {NAV_LINKS.map(({ href, label }) => (
            <Link
              ...
              className={`block px-3 py-2.5 rounded-xl text-sm font-medium transition-colors ${
                isActive(href) ? "text-green-700 bg-green-50" : "text-gray-700 hover:bg-gray-50"
              }`}
            >
              {label}
            </Link>
          ...
          <div className="pt-3 border-t border-gray-100 space-y-2">
            {user ? (
              ...
              <>
                <Link href="/auth" onClick={() => setMobileOpen(false)} className="flex items-center justify-center gap-1.5 py-2.5 rounded-xl border border-gray-200 text-sm font-medium text-gray-700">
